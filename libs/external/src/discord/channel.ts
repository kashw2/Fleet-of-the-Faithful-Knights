...
import {
    ...
    bitrateKey,
    guildIdKey, iconKey,
    idKey, lastMessageIdKey, lastPinTimestampKey,
    nameKey,
    nsfwKey, ownerIdKey, parentIdKey,
    permissionOverwritesKey,
    positionKey, rateLimitPerUserKey, recipientsKey,
    topicKey,
    typeKey, userLimitKey
} from "./json-keys";
...
export class ChannelJsonSerializer extends JsonSerializer<Channel> {
    ...
    toJson(value: Channel, builder: JsonBuilder): object {
        return builder.addOptional(value.getId(), idKey)
            ...
            .addIterable(value.getRecipients(), recipientsKey)
