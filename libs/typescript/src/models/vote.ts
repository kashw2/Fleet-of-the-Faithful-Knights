...
import {ballotsKey, candidateKey, createdKey, descriptionKey, groupKey, idKey, modifiedKey, sponsorKey, starCitizenUrlKey} from '../misc/json-keys';
...
export class Vote {
  ...
  public isKnightCaptain(): boolean {
    return this.getPromotionGroupName()
      .contains('Knight Captain');
  }
  ...
  public isKnightLike(): boolean {
    return this.isKnight()
      || this.isKnightLieutenant()
      || this.isKnightCommander()
      || this.isLieutenantKnightCommander()
      || this.isKnightCaptain()
      || this.isKnightMajor();
  }

  public isKnightMajor(): boolean {
    return this.getPromotionGroupName()
      .contains('Knight Major');
  }

  public isLieutenantKnightCommander(): boolean {
    return this.getPromotionGroupName()
      .contains('Lieutenant Knight Commander');
  }

  public isMasterSergeant(): boolean {
    return this.getPromotionGroupName()
      .contains('Master Sergeant');
  }
  ...
  public isSergeantLike(): boolean {
    return this.isSergeant()
      || this.isSergeantFirstClass()
      || this.isMasterSergeant()
      || this.isStaffSergeant();
  }

  public isStaffSergeant(): boolean {
    return this.getPromotionGroupName()
      .contains('Staff Sergeant');
  }
